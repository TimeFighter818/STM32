...
#define MOTOR1_DIR_PIN GPIOA,GPIO_Pin_4   //定义电机1的方向引脚
#define MOTOR1_EN_PIN GPIOC,GPIO_Pin_13			//定义电机1的使能引脚
#define MOTOR2_DIR_PIN GPIOA,GPIO_Pin_5
#define MOTOR2_EN_PIN GPIOC,GPIO_Pin_13
#define MOTOR3_DIR_PIN GPIOC,GPIO_Pin_4
#define MOTOR3_EN_PIN GPIOC,GPIO_Pin_13
#define MOTOR4_DIR_PIN GPIOC,GPIO_Pin_5
#define MOTOR4_EN_PIN GPIOC,GPIO_Pin_13
