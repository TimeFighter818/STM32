...
#define MOTOR1_DIR_PIN1 GPIOC,GPIO_Pin_4   //定义电机1的IN1引脚
#define MOTOR1_DIR_PIN2 GPIOC,GPIO_Pin_5  	//定义电机1的IN2引脚
#define MOTOR1_EN_PIN GPIOB,GPIO_Pin_0

#define MOTOR2_DIR_PIN1 GPIOB,GPIO_Pin_10
#define MOTOR2_DIR_PIN2 GPIOB,GPIO_Pin_11
#define MOTOR2_EN_PIN GPIOB,GPIO_Pin_1

#define MOTOR3_DIR_PIN1 GPIOA,GPIO_Pin_4
#define MOTOR3_DIR_PIN2 GPIOA,GPIO_Pin_5
#define MOTOR3_EN_PIN GPIOA,GPIO_Pin_6

#define MOTOR4_DIR_PIN1 GPIOC,GPIO_Pin_13
#define MOTOR4_DIR_PIN2 GPIOC,GPIO_Pin_15
#define MOTOR4_EN_PIN GPIOA,GPIO_Pin_7
